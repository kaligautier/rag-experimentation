"""Repository integration tests against an explicit pgvector test database.

Set RAG_TEST_DB_URL to a PostgreSQL+asyncpg URL with vector installed in public.
Each test owns a unique schema; application tables are never reused or removed.
"""
...
from app.adapters.persistence.entities import Base, RagChunkEntity
